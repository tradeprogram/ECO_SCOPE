...
|---|---|---|
| 개방수면 | 996 | **0.976** |
| 개방수면 소실 (식생 추정) | 33 | 0.818 |
| 개방수면 소실 (산란체 없음) | 6 | 1.000 |
...
소실 구간은 두 센서가 모두 0에 가까워 자동으로 일치합니다.
...
| 품질 게이트 연도별 판정 | 기준선이 문턱 근처인 습지에서 소실 비중이 0%↔79% 로 요동 | 습지 단위 판정으로 교체 |
