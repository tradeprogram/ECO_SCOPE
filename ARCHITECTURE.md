...
**면적은 검증되지 않았습니다.** 임계값을 바꾸어도 R² 는 0.03~0.08 에 머물러
임계 선택의 문제가 아닙니다. 원인을 확인한 결과, 개방수면율의 **41~87%** 가
...
| 임시 경계 사용 | 판독 성립률 24%. 간척지·시가지를 문 폴리곤 | 에코뱅크 정본 연동 |
